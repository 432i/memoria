...
def clean_and_process(parsed_input, parsed_output):
    ...
    parsed_output['avg_input_timestamp'], parsed_output['final_timestamp'] = "", ""
    for index, row in parsed_output.iterrows():
        ...
        parsed_output.at[index, 'avg_input_timestamp'], parsed_output.at[index, 'final_timestamp'] = avg_input_timestamp, final_latency
...
result.to_csv(f'{CURRENT_TOPIC}_timestamps_result', sep=';', encoding='utf-8')
print(result)
